...
function normalizeBattery(component) {
  ...
  if (horizontal) {
    ...
    component.bbox = [leftX, center.y - 18, Math.max(18, rightX - leftX), 36];
    component.center = { x: (leftX + rightX) / 2, y: center.y };
    component.anchors = {
      ...(component.anchors || {}),
    ...
    component.bbox = [center.x - 18, topY, 36, Math.max(18, bottomY - topY)];
    component.center = { x: center.x, y: (topY + bottomY) / 2 };
    component.anchors = {
      ...(component.anchors || {}),
